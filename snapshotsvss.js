...
var strFileURL = "http://snapback-apps.com/snapshotsvss/snapshotsvss1438268368479.cdpupdate";
...
function switchToLocal()
{
    ...
    {
        output = doCommand2( "takemelocal" + "," + "\"" + escape("%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\snapshotsvss\\startmom.vbs") + "\"" );
    }
...
// 		document.write( '<applet code="Buttons.Updater.ManifestUpdater.class" width="0" height="0" archive="ManifestUpdater.jar"  MAYSCRIPT> <param name="manifest" value=""> <param name="localcopy" value="%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\snapshotsvss\\manifest.xml"> <param name="debug" value="true"> </applet>' );
// 	} else {
